...
## Project Structure
    ...
    ├── testapiautoconnecto_56836  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_56836`
...
2. Clone this repo and `cd testapiautoconnecto_56836`
